...
gulp.task('default', gulp.series(
  // 'checkhooks',
  'clean',
   gulp.parallel('fonts', 'images', 'styles', 'assets', 'favicon', 'html'),
...
gulp.task('build', gulp.series(
  ...
  'clean',
  gulp.parallel('fonts', 'images', 'scripts', 'styles', 'assets', 'favicon', 'html'),
  'purgecssOptimize',
...
gulp.task('production', gulp.series(
  'prebuild', // set production global variable
  'clean',
  gulp.parallel('fonts', 'images', 'scripts', 'styles', 'assets', 'favicon', 'html', 'worker'),
  'purgecssOptimize',
  'purgecssOptimizeHome',
  'sizereport',
  'demo'
